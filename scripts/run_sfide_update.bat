...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "python -u scripts\update_hotspot_databases.py --sfide-source-dir $source --firms-source-dir $firmsSource --output-dir $output --output-format fgb --git --progress-interval-seconds 5 2>&1 | Tee-Object -FilePath $log -Append;" ^
  "$code = $LASTEXITCODE;" ^
